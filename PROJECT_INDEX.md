...
| 저장소                                                                                      | 역할                                                                                                                       |
| ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| [koreainvestment/open-trading-api](https://github.com/koreainvestment/open-trading-api.git) | 한국투자증권 공식 Open API 샘플 (Python 주력). `examples_llm/`·`examples_user/`·`auth/` 코드를 copy & adapt 방식으로 적용. |

> **구현 전략:** 위 저장소의 샘플 코드를 직접 복사하고 quanteo 아키텍처에 맞게 적응(adapt)한다.
> 샘플을 가져올 때는 출처 경로를 커밋 메시지나 주석에 남겨 공식 저장소 업데이트와 추후 대조할 수 있게 한다.
